...
function __init_lf() {
    ...
    export pkg_cmd_name="lf"

    export pkg_dst_cmd="$HOME/.local/bin/lf"
    export pkg_dst="$pkg_dst_cmd"

    export pkg_src_cmd="$HOME/.local/opt/lf-v$WEBI_VERSION/bin/lf"
    export pkg_src_dir="$HOME/.local/opt/lf-v$WEBI_VERSION"
