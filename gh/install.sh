...
function __init_gh() {
    ...
    export pkg_cmd_name="gh"

    export pkg_dst_cmd="$HOME/.local/bin/gh"
    export pkg_dst="$pkg_dst_cmd"

    export pkg_src_cmd="$HOME/.local/opt/gh-v$WEBI_VERSION/bin/gh"
    export pkg_src_dir="$HOME/.local/opt/gh-v$WEBI_VERSION"
