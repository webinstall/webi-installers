...
function __init_syncthing() {
    ...
    export pkg_cmd_name="syncthing"

    export pkg_dst_cmd="$HOME/.local/bin/syncthing"
    export pkg_dst="$pkg_dst_cmd"

    export pkg_src_cmd="$HOME/.local/opt/syncthing-v$WEBI_VERSION/bin/syncthing"
    export pkg_src_dir="$HOME/.local/opt/syncthing-v$WEBI_VERSION"
