...
function __init_ffmpeg() {
    ...
    export pkg_cmd_name="ffmpeg"

    export pkg_dst_cmd="$HOME/.local/bin/ffmpeg"
    export pkg_dst="$pkg_dst_cmd"

    export pkg_src_cmd="$HOME/.local/opt/ffmpeg-v$WEBI_VERSION/bin/ffmpeg"
    export pkg_src_dir="$HOME/.local/opt/ffmpeg-v$WEBI_VERSION"
