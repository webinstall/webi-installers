...
tagline: |
  QuarticC - An explicit programming language for systems developers.
alias: qcm
description: |
  QCM is the official QuarticC toolchain. It installs, updates, and manages QuarticC compilers, packages, and projects.
---
