...
function __init_watchexec() {
    ...
    export pkg_cmd_name="watchexec"

    export pkg_dst_cmd="$HOME/.local/bin/watchexec"
    export pkg_dst="$pkg_dst_cmd"

    export pkg_src_cmd="$HOME/.local/opt/watchexec-v$WEBI_VERSION/bin/watchexec"
    export pkg_src_dir="$HOME/.local/opt/watchexec-v$WEBI_VERSION"
