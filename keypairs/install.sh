...
function __init_keypairs() {
    ...
    export pkg_cmd_name="keypairs"

    export pkg_dst_cmd="$HOME/.local/bin/keypairs"
    export pkg_dst="$pkg_dst_cmd"

    export pkg_src_cmd="$HOME/.local/opt/keypairs-v$WEBI_VERSION/bin/keypairs"
    export pkg_src_dir="$HOME/.local/opt/keypairs-v$WEBI_VERSION"
