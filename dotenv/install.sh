...
function __init_dotenv() {
    ...
    export pkg_cmd_name="dotenv"

    export pkg_dst_cmd="$HOME/.local/bin/dotenv"
    export pkg_dst="$pkg_dst_cmd"

    export pkg_src_cmd="$HOME/.local/opt/dotenv-v$WEBI_VERSION/bin/dotenv"
    export pkg_src_dir="$HOME/.local/opt/dotenv-v$WEBI_VERSION"
