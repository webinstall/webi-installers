...
**Note**: connect with a user that has the host `%` and DOES NOT have a
`localhost` or `127.0.0.1` entry - otherwise the client may "upgrade" to a
socket connection and fail.

### Remove Default Access Users
